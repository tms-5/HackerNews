...
/**
 * @vue/test-utils v2.4.5
 * (c) 2024 Lachlan Miller
 * Released under the MIT License
 */

import * as Vue from 'vue';
import { isRef, nextTick, setDevtoolsHook, Transition, BaseTransition, TransitionGroup, defineComponent, h, shallowReactive, reactive, ref, createApp, transformVNodeArgs, initDirectivesForSSR, createVNode, ssrContextKey, warn, Fragment, Static, Comment, Text, mergeProps, ssrUtils, computed } from 'vue';
...
var isDeepRef = function (r) {
    return isRef(r) || (isObject$1(r) && Object.values(r).some(isDeepRef));
};
