...
import { isRef, nextTick, setDevtoolsHook, Transition, BaseTransition, TransitionGroup, defineComponent, h, shallowReactive, reactive, ref, createApp, transformVNodeArgs, computed } from 'vue';
...
var isDeepRef = function (r) {
    return isRef(r) || (isObject(r) && Object.values(r).some(isDeepRef));
};
